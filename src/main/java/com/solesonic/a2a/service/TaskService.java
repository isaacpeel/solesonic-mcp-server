...
public class TaskService {
    ...
    public TaskService(RequestHandler requestHandler, ServerCallContextFactory serverCallContextFactory) {
        this.requestHandler = requestHandler;
        this.serverCallContextFactory = serverCallContextFactory;
    }

    public ResponseEntity<SendMessageResponse> send(SendMessageRequest request) {
    ...
    public ResponseEntity<GetTaskResponse> getTask(GetTaskRequest request) {
        ServerCallContext context = serverCallContextFactory.create();
    ...
    public ResponseEntity<CancelTaskResponse> cancelTask(CancelTaskRequest request) {
        ServerCallContext context = serverCallContextFactory.create();
